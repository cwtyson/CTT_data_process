...
hpc_localize_zebby_fn <- function(file_f,
  ...
  file_f = '/Users/tyson/Library/CloudStorage/GoogleDrive-cwtyson@gmail.com/Other computers/My Mac/processed_data/gt/processed_detections/ml_prepared/2025/BK81883/2025-12-06.csv.gz'
  rssi_dist_model_file = "/Users/tyson/Documents/git/CTT_data_process/R/data/RSSI_log_dist_model_gt.RDS"
  ...
  for(int in unique(dets_p$int_id)){
    ...
    tag_int_loc_est <- dets_p_int %>% 
      ...
      mutate(mean_RSSI = mean(dets_p_int$rssi_gp_r),
             ...
             semi_minor = b,
             orientation = theta,
             gps = paste(dets_p_int$grid_point,collapse = "-"))
