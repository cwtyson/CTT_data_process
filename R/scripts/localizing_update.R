...
tags <- list.files("/Users/tyson/Documents/academia/research/zebby_tracking/data/processed_detections/prepared/w_error/60s/")

foreach(tag_f=tags,.packages=c("tidyverse","lubridate","readr"), 
        .verbose = TRUE) %dopar% 
  { update_localization(db_name = "tyson",
                        db_user = "tyson",
                        db_password = "time00",
